...
version is rejected normally; inspect [result acceptance](./returning#acceptance).
...
[save assignment expression](./assignment):
...
[Insert/upsert from select](../insert-from-select) uses assignment semantics for
