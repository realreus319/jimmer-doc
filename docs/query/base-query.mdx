...
[insert/upsert commands](../mutation/insert-from-select#select-an-entity-table).
...
class. A [typed-tuple mapper](./typed-tuple) gives the result named properties;
the [insert-from-select example](../mutation/insert-from-select) shows a complete
...
See [Insert and Upsert from Select](../mutation/insert-from-select).
